...
// in bookly/test/helpers/test_helpers.dart.
...
import 'package:bookly/models/book.dart' as _i8;
import 'package:bookly/services/api_service.dart' as _i7;
...
class MockApiService extends _i1.Mock implements _i7.ApiService {
  @override
  _i5.Future<List<_i8.Book>> getBooks({String? genreType = 'computers'}) =>
      (super.noSuchMethod(
        Invocation.method(
          #getBooks,
          [],
